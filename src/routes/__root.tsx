...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Enxoval — Coleções compartilhadas de links" },
      { name: "description", content: "Organize e compartilhe coleções de links para seu enxoval e lista de casa. Colaborativo, sem cadastro." },
      { property: "og:title", content: "Enxoval — Coleções compartilhadas" },
      { property: "og:description", content: "Organize e compartilhe coleções de links para seu enxoval." },
